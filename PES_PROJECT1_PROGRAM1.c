...
#include <math.h>
#include <stdlib.h>
int dec (int r, unsigned int n);                                         /*Function prototype declaration of decimal,octal,hexadecimal
...
int num, Decimal,Decimal_absolute, radix, op_size, Octal, Hexadecimal,
...
int dec (int r, unsigned int n)                                                 /*Function to calculate decimal equivalent of input
                                                                                    with a radix value of 8,10 or 16*/
{
    int remainder, sum = 0, x = 0;
...
int dec2oct (int dec)                                   /*calculate octal equivalent of decimal by storing remainder of division
...
int dec2hex (int dec)                                   /*calculate hexadecimal equivalent of decimal by storing remainder of division
                                                        by 8 which is decremented in each loop iteration and calculate sum by storing
                                                        remainder in reverse order*/
{
    int sum = 0, x = 1, rem;
...
void
sign1comp_dec2bin (int Sign1complement_dec, int op_size)          /*calculate the binary equivalent of sign 1 complement*/
{
    int i = 1;                                                  /*Initializing value i needed to be used later*/
    int l = op_size;                                            /*length of binary bits which the decimal has to be converted into*/
    ...
    int j = op_size-1;                                          /*Initializing value j which will be the last element of array*/
...
void
sign2comp_dec2bin (int Sign2complement_dec, int op_size)
{
    int i = 1;                                                  /*Initializing value i needed to be used later*/
    int l = op_size;                                            /*length of binary bits which the decimal has to be converted into*/
    char bin[op_size+1];                                        /*Initializing array where binary value will be stored*/
...
int sign_magnitude_dec (int Decimal, int op_size)       /* calculate the sign_magnitude whose msb is 1 if input is negative and msb is 0
                                                            input is positive*/
{
    int Sign_mag_dec;                          /*if operand size is 4, calculate sign_magnitude by doing bitwise Xor operation
...
void
sign_mag_dec2bin (int Signed_magnitude_dec,int op_size)
{
    int i = 1;                                                    /*Initializing value i needed to be used later*/
    int l = op_size;                                             /*length of binary bits which the decimal has to be converted into*/
    char bin[op_size+1];                                         /*Initializing array where binary value will be stored*/
